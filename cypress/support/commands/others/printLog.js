// How to use custom log:
// cy.print({ title: 'My Log Title', message: 'My log message', type: 'info' });
//
// Log with variables:
// cy.print({ title: 'LOG', message: `Discount code is ${discountCode}`, type: 'warning' });
//
// Link: https://github.com/cypress-io/cypress/issues/2134#issuecomment-1692593562
...
Cypress.Commands.add('print', cyPrint)
